...
My agents consumes it for display; mention pickers exclude known-archived
identities while actual channel membership still governs notifications. `not-archived` means absent from the read snapshot, not online,
