...
- Only profiles linked to multiple distinct keys need a short npub suffix. Names
  alone never create a group. Suffix collisions extend deterministically using
