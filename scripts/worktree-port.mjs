...
// so this reads spawnSync's exit status rather than catching a throw. Everything
// a worktree derives for itself, its port and its deep-link scheme, hashes this
// one value, so the two stay consistent and stable across branch switches.
