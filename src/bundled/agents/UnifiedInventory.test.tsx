...
it("omits redundant profile text and retains displayed discovery names for native WSS setups in an HTTPS session", async () => {
  ...
  expect(
    screen.queryByRole("article", { name: "Agent Raw local fallback" }),
  ).toBeNull();
});
