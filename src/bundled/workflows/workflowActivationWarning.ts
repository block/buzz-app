...
/** Mirrors the relay's normalization of 5- and 6-field cron to 7 fields. */
...
/**
 * Warn before enabling a workflow that will run often. Schedule execution
 * belongs to the relay; this only reads the shapes it will accept.
 */
