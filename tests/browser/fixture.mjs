...
export const test = base.extend({
  ...
  developmentMode: [false, { option: true, scope: "worker" }],
  ...
  app: async (
    ...
    const report = {
      state: {
        ...
        build: `${developmentMode ? "Vite development-mode build" : developmentReact ? "Vite production build with development React" : "production frontend"}; ${productionBroker ? "production broker; modeled upstream WS/HTTP policy" : "fixture broker HTTP"}; no native or real relay`,
      },
      queries: [],
      publications: [],
      readPublications: [],
