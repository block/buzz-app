  ...
  return (
    <>
      ...
      <Section
        ...
        description="Named color relationships, system rules and approved UI patterns. Their definitions and purposes are listed below; authoring policy lives in AGENTS.md."
      >
        <div className="flex flex-col gap-8">
