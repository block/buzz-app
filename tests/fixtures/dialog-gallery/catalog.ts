...
export const dialogs = [
  ...
  },
  {
    ...
    group: "Shared dialogs",
    path: "App header → current community",
    source: "src/features/communities/CommunitySwitcher.tsx",
    frame: "Dialog",
    note: "Personal space, joined communities, and Add a community. The latter opens a second dialog.",
  },
  {
    id: "join",
    name: "Add a community",
    group: "Shared dialogs",
    path: "Community chooser → Add a community",
